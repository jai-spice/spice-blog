...
abstract class $SignInFormStateCopyWith<$Res> {
  ...
  $Res call({Email email, Password password, bool isObscure});
}
...
class _$_SignInFormState implements _SignInFormState {
  ...
  @override
  String toString() {
    return 'SignInFormState(email: $email, password: $password, isObscure: $isObscure)';
  }
...
abstract class _SignInFormState implements SignInFormState {
  factory _SignInFormState(
      {final Email email,
      final Password password,
      final bool isObscure}) = _$_SignInFormState;
